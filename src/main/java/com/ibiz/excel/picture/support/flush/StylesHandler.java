...
public class StylesHandler implements InvocationHandler {
    ...
    private StringBuilder xfBefore = new StringBuilder("</fills><borders count=\"10\"><border><left/><right/><top/><bottom/><diagonal/></border><border><left style=\"thin\"><color auto=\"1\"/></left><right style=\"thin\"><color auto=\"1\"/></right><top style=\"thin\"><color auto=\"1\"/></top><bottom style=\"thin\"><color auto=\"1\"/></bottom><diagonal/></border><border><left style=\"double\"><color rgb=\"FF3F3F3F\"/></left><right style=\"double\"><color rgb=\"FF3F3F3F\"/></right><top style=\"double\">" +
            ...
            "<xf numFmtId=\"0\" fontId=\"10\" fillId=\"19\" borderId=\"0\" applyNumberFormat=\"0\" applyBorder=\"0\" applyAlignment=\"0\" applyProtection=\"0\"><alignment vertical=\"center\"/></xf></cellStyleXfs>" +
            "<cellXfs count=\"3\">" +
            "<xf numFmtId=\"0\" fontId=\"0\" fillId=\"0\" borderId=\"0\" xfId=\"0\" applyFont=\"1\"><alignment vertical=\"center\"/></xf>" +
            "<xf numFmtId=\"0\" fontId=\"0\" fillId=\"2\" borderId=\"1\" xfId=\"0\" applyFont=\"1\" applyFill=\"1\" applyBorder=\"1\" applyAlignment=\"1\"><alignment horizontal=\"center\" vertical=\"center\" wrapText=\"1\"/></xf>" +
    ...
    private StringBuilder xfAfter = new StringBuilder("</cellXfs>" +
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if (method.getName().equals("write")) {
            ...
            if (!rows.isEmpty()) {
                // 判断是否最后
                if (sheet.getRowCount() % sheet.getFlushSize() - rows.size() % sheet.getFlushSize() == 1) {
                    last = false;
                }
    ...
    private void appendFill(CellStyle cellStyle) {
        target.append("<fill><patternFill patternType=\"solid\"><fgColor rgb=\"" + cellStyle.getFgColorRgb() + "\"/><bgColor indexed=\"64\"/></patternFill></fill>");
    }
